...
import { createRecurringAvailability } from '@/lib/actions/availability';
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Ajouter des disponibilités récurrentes</DialogTitle>
          <DialogDescription>
            Créez des disponibilités sur plusieurs jours en une seule fois
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t">
            ...
            <Button type="submit" disabled={isLoading}>
              {isLoading ? 'Création...' : 'Créer les disponibilités'}
            </Button>
          </div>
        </form>
      </DialogContent>
